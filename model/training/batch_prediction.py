...
from .model_fine_tuning import get_bounding_box, model_image
...
def show_mask(mask, ax, random_color=False):
    if random_color:
        ...
        color = np.array([30 / 255, 144 / 255, 255 / 255, 0.6])  # shape = (4,)
    h, w = mask.shape[-2:]  # last two dimension
    # broadcast color value (4 channel) to mask area at each pixel, shape = (h, w , 4)
